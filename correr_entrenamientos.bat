...
REM --- 4b. Generar CORTES DE VIDEO de entrenamiento (datos_video_ent.js) ---
echo  Generando cortes de video de los entrenamientos...
echo.
...
if exist datos_video_ent.js echo     - datos_video_ent.js  (cortes de video de entrenos)
echo.
