...
echo.
echo  [6/8] Game plans por rival...
python actualizar_gameplan.py
if errorlevel 1 echo      [aviso] Problema en game plans. Sigo igual.
echo.
echo  [7/8] Videos destacados (si hay Excel)...
if exist "videos_casla.xlsx" python build_videos.py videos_casla.xlsx
echo.
echo  [8/8] Cortes de video de partidos...
